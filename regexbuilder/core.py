...
def is_pro_edition():
    ...
    #  removed in the upcoming migration to regexbuilder version 1.x.
...
class RegexBuilder:
    ...
    kwargs (dict): an optional keyword arguments.
            ...
            Pro or Enterprise edition will be deprecated and removed in
                the upcoming migration to regexbuilder version 1.x.
...
class DynamicTestScriptBuilder:
    ...
    kwargs (dict): an optional keyword arguments.
            ...
            Pro or Enterprise edition will be deprecated and removed in the
                upcoming migration to regexbuilder version 1.x.
                prepended_ws, appended_ws, ignore_case, other keywords
