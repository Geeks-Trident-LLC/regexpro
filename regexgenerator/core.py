...
from regexgenerator.exceptions import RegexBuilderError
from regexgenerator.exceptions import PatternReferenceError
from regexgenerator.exceptions import NoUserDataError
from regexgenerator.exceptions import NoTestDataError
...
def is_pro_edition():
    """return True if regexgenerator is Pro or Enterprise edition"""
    # TODO: Regex Pro Edition and Enterprise Edition will be deprecated and
    #  removed in the upcoming migration to regexgenerator version 1.x.
    chk = regexgenerator.edition == 'Pro' or regexgenerator.edition == 'Enterprise'
    return chk
...
def create_docstring(test_framework='unittest',
    ...
    lst.append(fmt.format(lang, test_framework, regexgenerator.edition))
    lst.append('')
...
class RegexBuilder:
    ...
    kwargs (dict): an optional keyword arguments.
            ...
            Pro or Enterprise edition will be deprecated and removed in
                the upcoming migration to regexgenerator version 1.x.
...
class DynamicTestScriptBuilder:
    ...
    kwargs (dict): an optional keyword arguments.
            ...
            Pro or Enterprise edition will be deprecated and removed in the
                upcoming migration to regexgenerator version 1.x.
                prepended_ws, appended_ws, ignore_case, other keywords
